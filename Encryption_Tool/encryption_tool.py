...
def decrypt():
    ...
    if password=="1234":
     ...
     text2=Text(screen2,font="Robute 10", bg= "white", relief=GROOVE,wrap=WORD,bd=0)
...
def encrypt():
    ...
    if password=="1234":
     ...
     text2=Text(screen1,font="Robute 10", bg= "white", relief=GROOVE,wrap=WORD,bd=0)
     text2.place(x=10,y=40,width=380,height=150)
...
Entry(textvariable=code,width=19,bd=0,font=("arial",25),show="*").place(x=10,y=200)
 ...
 #root = Label(text="Welcome to Encryption & Decryption App")
 #root.pack()
